 ...
 * from within a Java module you must still open the module to the naturalis-common
 * module.
 *
...
public final class BeanWriter<T> {
   ...
   * (if necessary) input values to the type of the destination property. You can
   * optionally specify an array of properties that you intend to write. Specifying a
   * zero-length array means all properties will be writable.
   *
   ...
   * array all properties will be writable.
   *
   * @param beanClass The bean class
   * @param properties The properties you allow to be written
   */
   ...
   * first bean. This can potentially nullify non-null properties in the second
   * bean.
   *
  ...
  /**
   * Overwrites all properties in the second bean whose value is {@codd null} with
  ...
  /**
   * Returns the bean properties that can be set by this {@code BeanWriter}. This may
   * be a subset of all writable properties of the bean class, as the constructor
   * allows you to {@link BeanWriter#BeanWriter(Class, String...) exclude} properties
   * from being set by this {@code BeanWriter}.
   *
