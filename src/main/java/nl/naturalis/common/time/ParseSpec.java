...
/**
 * <p>
 * A {@code ParseSpec} specifies how to parse a date string. It minimally consists of a date/time pattern string or a
 * {@link DateTimeFormatter} instance. A {@link FuzzyDateParser} is instantiated with a list of <code>ParseSpec</code> instances. When
 * parsing a date string it iterates over these <code>ParseSpec</code> instances in order the produce a {@link FuzzyDate}.
 * </p>
 * <p>
 ...
 * <li>One or more {@code TemporalQuery} objects that effectively specify into which type of date/time object you want the date string to be
 * parsed. <i>Optional.</i> Ordinarily you would specify them in descending order of granularity, but that is not required.
 * <li>A {@link UnaryOperator} that transforms the date string <b>before</b> it is passed on to the {@code DateTimeFormatter}.
 * <i>Optional.</i> If the operator returns null, the date string will be treated as unparsable.
 * </ol>
 * </p>
 */
public final class ParseSpec {
  ...
  /**
   * Creates a <code>ParseSpec</code> using the provided date/time pattern and the provided array of {@code TemporalQuery} objects. The
   * array may be null or zero-length.
   * 
   * @param pattern
   * @param parseInto
   */
  ...
  /**
   * Creates a <code>ParseSpec</code> using the provided {@link DateTimeFormatter} and the provided array of {@code TemporalQuery} objects.
   * The array may be null or zero-length.
   * 
   * @param formatter
   * @param parseInto
   */
  ...
  /**
   * Returns the date/time pattern used to parse the date string or null if the {@code ParseSpec} was instantiated with a ready-made
