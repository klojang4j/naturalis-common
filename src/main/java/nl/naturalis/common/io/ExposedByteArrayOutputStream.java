...
public class ExposedByteArrayOutputStream extends OutputStream {
  ...
  /**
   * Creates a new {@code TransparentByteArrayOutputStream}. The buffer capacity is initially 512
   * bytes, though its size increases if necessary. When it reaches full capacity its replaced with
  ...
  /**
   * Creates a new {@code TransparentByteArrayOutputStream}. The buffer initially has the specified
  ...
  /**
   * Creates a new {@code TransparentByteArrayOutputStream} that wraps around the specified byte
   * array. When it reaches full capacity its replaced with a buffer twice its size.
   *
  ...
  /**
   * Creates a new {@code TransparentByteArrayOutputStream}. The buffer capacity is initially {@code
  ...
  /**
   * Returns the byte array that this instance is writing to (not a copy of it).
   *
   * @return
   */
