...
public class ArrayMethods {
  ...
  /**
   * Creates and returns a new array containing all elements of the provided
   * arrays.
   *
   * @param <T> The element type of the arrays
   * @param array1 The 1st array to go into the new array
   * @param array2 The 2nd array to go into the new array (adjacent to the 1st
   *        array)
  ...
  /**
   * Returns an array for a generic type, using the provided array as a template.
   * The returned array will have the same length and element type as the provided
   * array.
   *
  ...
  /**
   * Returns an array for a generic type, using the provided array as a template.
   * The returned array will have the same element type as the provded array. The
   * length of the provided array is specified through the {@code length}
   * parameter.
   *
   * @param <T> The type of the elements in the requested array
