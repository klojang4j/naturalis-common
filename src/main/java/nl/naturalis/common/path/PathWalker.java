...
public final class PathWalker {
  ...
  public void readValues(Object host, Object[] values) throws PathWalkerException {
    Check.notNull(values, "output").hasInt(Array::getLength, "length", atLeast(), paths.length);
  ...
  public void writeValues(Object host, Object... values) {
    Check.notNull(values, "values").hasInt(Array::getLength, "length", atLeast(), paths.length);
