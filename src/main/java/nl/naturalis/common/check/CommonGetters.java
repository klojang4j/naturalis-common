 ...
 * from using the functions defined here for other purposes than precondition checking. For
 * example:
 *
 * <blockquote>
 *
...
public class CommonGetters {
     ...
     * @return A {@code Function} that returns the result of calling {@code toString()} on the
     * object.
     */
    ...
    /**
     * A {@code Function} that returns the keys of a {@code Map}. Equivalent to {@code
     * Map::keySet}.
     *
     ...
     * Can be used if there already is a {@code size()} method in the class in which to execute a
     * size check.
     *
