...
public final class ObjectCheck<T, E extends Exception> {
   ...
   * call</b>. You can circumvent this in various ways:
   *
   * <ol>
  ...
  /**
   * Ensures that the argument does not pass the specified test. Allows you to provide a custom
   * error message. See the {@link nl.naturalis.common.check package comments} for how to specify a
   * custom message.
   *
   * @param test A {@code Predicate} expressing the test
  ...
  public ObjectCheck<T, E> is(IntRelation test, int object, String message, Object... msgArgs)
      throws E {
    if (applicable()) {
      int i = (((Number) arg).intValue());
      if (test.exists(i, object)) {
  ...
  /**
   * public abstract <U> ObjectCheck<T, E> is(IntObjRelation<U> test, U object) throws E; Verifies
   * that the argument passes the test expressed through the specified {@code IntObjRelation}.
   * Although not strictly required, this method is meant to be used with an {@code IntObjRelation}
  ...
  /**
   * public abstract ObjectCheck<T, E> is(IntRelation test, int object) throws E; Verifies that the
   * argument passes the test expressed through the specified {@code IntRelation}. Although not
   * strictly required, this method is meant to be used with an {@code IntRelation} from the {@link
  ...
  /**
   * public abstract ObjectCheck<T, E> isNot(IntRelation test, int object) throws E; Verifies that
   * the argument ducks the test expressed through the specified {@code IntRelation}. Although not
   * strictly required, this method is meant to be used with an {@code IntRelation} from the {@link
   * CommonChecks} class so that an informative error message is generated if the argument fails the
   * test.
   *
