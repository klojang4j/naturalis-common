...
public class OptionalMethods {
  ...
  /**
   * Narrows the contents of the provided {@code Optional} to an instance of {@code U} and returns it
   * within a new {@code Optional}. If the provided {@code Optional} is empty, the {@code Optional}
   * itself is returned. Only use this method if you <i>know</i> that what's inside the provided
   * {@code Optional} is a subclass or implementation of {@code T} or you risk getting a
  ...
  /**
   * Widens the type of the provided optional. This method always returns the provided
   * {@code Optional} itself.
   * 
   * <pre>
