...
public class CommonGettersTest {
  ...
  @Test
  public void test00() {
    // Just something that is not a key in CommonGetters.NAMES
  ...
  public void keySet00() {
    ...
    System.out.println(propName);
    assertEquals("map keys", propName);
  }
  ...
  public void values00() {
    ...
    System.out.println(propName);
    assertEquals("map values", propName);
  }
  ...
  public void key00() {
    ...
    System.out.println(propName);
    assertEquals("entry.getKey()", propName);
  }
