...
public class UnsafeByteArrayOutputStreamTest {
  ...
  @Test
  public void test00() {
    @SuppressWarnings("resource") UnsafeByteArrayOutputStream out = new UnsafeByteArrayOutputStream(
        2);
  ...
  public void test07() {
    ...
    assertArrayEquals("02",
        new byte[] {33, 34, 35, 123, 7, 22, 16},
        out.toByteArray());
  }
