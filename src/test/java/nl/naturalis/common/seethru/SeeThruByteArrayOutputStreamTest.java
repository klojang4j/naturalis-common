...
public class SeeThruByteArrayOutputStreamTest {
  @Test
  public void test00() {
    @SuppressWarnings("resource")
    SeeThruByteArrayOutputStream out = new SeeThruByteArrayOutputStream(2);
  ...
  public void test03() {
    @SuppressWarnings("resource")
    SeeThruByteArrayOutputStream out = new SeeThruByteArrayOutputStream(2, 1, IncrementType.TERM);
