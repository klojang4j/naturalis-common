...
public class ObjectMethodsTest {
  ...
  public void isNotEmpty00() {
    ...
    assertFalse(isNotEmpty(Optional.empty()));
    assertFalse(isNotEmpty(Optional.of(List.of())));
    assertTrue(isNotEmpty(Optional.of("Hello")));
    assertTrue(isNotEmpty("foo"));
    assertTrue(isNotEmpty(List.of("foo", "bar")));
    assertTrue(isNotEmpty(Set.of("foo", "bar")));
